...
$(function () {
    $("#pieChart").drawPieChart([
      { title: "Attention", value: 130, color: "#fdb80d" },
      { title: "Memorie", value: 70, color: "#a0c823" },
      { title: "Flexibilite", value: 90, color: "#0e91a1" },
      { title: "Logique", value: 30, color: "#ab81d0" },
      { title: "Vitesse", value: 70, color: "#ff7f7f" }
    ]);
});
